...
EXPECTED={"D1_low_risk_readme":("awaiting_maintainer_verification","normal_pr_review",0),"D2_high_risk_missing":("evidence_incomplete","contributor_action_required",0),"D3_high_risk_ready":("awaiting_maintainer_verification","maintainer_focused_review",2),"D4_no_agent_trace":("awaiting_maintainer_verification","normal_pr_review",0),"D5_no_agent_high_missing_test":("evidence_incomplete","contributor_action_required",0),"D6A_declaration_conflict":("awaiting_maintainer_verification","maintainer_action_required",1),"D6B_repair_requested":("repair_requested","contributor_action_required",0),"D7_stale_test":("resubmitted","contributor_action_required",0),"D8_system_handled":("awaiting_maintainer_verification","normal_pr_review",0),"D9_contributor_waiting":("evidence_incomplete","waiting_for_contributor_submission",0),"D10_final_recommendation":("accepted","final_recommendation_recorded",0)}
